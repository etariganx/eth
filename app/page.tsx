...
export default function DailyUpdateTradingJournal() {
  ...
  const handleSearch = () => {
    ...
    if (!categories.includes(search.toUpperCase())) {
      setCategories([...categories, search.toUpperCase()]);
    }
  };
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <div className="w-full text-center py-6">
        <h1 className="text-3xl font-bold">Daily Update Trading Journal</h1>
        ...
        <div className="border-b-2 border-black mt-6 w-full"></div>
      </div>
